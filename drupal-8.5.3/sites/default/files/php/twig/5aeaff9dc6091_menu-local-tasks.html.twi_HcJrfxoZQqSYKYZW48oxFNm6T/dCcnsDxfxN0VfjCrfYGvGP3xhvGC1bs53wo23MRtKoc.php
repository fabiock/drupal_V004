...
class __TwigTemplate_3300aeebda8572ff44b8cf294784421e828f50fcb095dec106d14108e058985e extends Twig_Template
{
...
";
        // line 19
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("basic/tabs"), "html", null, true));
        echo "
...
";
    ...
    {
        return new Twig_Source("", "themes/basic/templates/menu-local-tasks.html.twig", "/Applications/MAMP/htdocs/drupal_V003/drupal-8.5.3/themes/basic/templates/menu-local-tasks.html.twig");
    }
}
